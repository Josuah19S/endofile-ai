 ...
 * Order must match the output tensor contract of the v1 graph.
 */
 ...
 */
export const FILE_CLASSES_V2 = FILE_CLASSES;
...
export interface ModelConfig {
  ...
  normalization: 'efficientnet' | 'none';
...
export const MODEL_CONFIGS: Record<ModelVersion, ModelConfig> = {
  v1: {
    ...
    description: '28 clases · Normalización [-1, 1]',
    classCount: 28,
  ...
  v2: {
    ...
    description: '29 clases · Normalización integrada',
    classCount: 29,
