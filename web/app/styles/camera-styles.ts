...
export const cameraStyles = {
  ...
  focusCornerTL: "absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-on-surface rounded-tl-xs",
  focusCornerTR: "absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-on-surface rounded-tr-xs",
  focusCornerBL: "absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 border-on-surface rounded-bl-xs",
  focusCornerBR: "absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-on-surface rounded-br-xs",
